 ...
 * @author Arsiela
 */
public class Model_VehicleSalesInvoice_Master implements GEntity {
     ...
     */
    public Model_VehicleSalesInvoice_Master(GRider foValue) {
        if (foValue == null) {
...
//                setReferNo(MiscUtil.getNextCode(getTable(), "sReferNox", true, poGRider.getConnection(), poGRider.getBranchCode()));
               ...
               // lsSQL = "Select * FROM " + getTable() + " a left join (" + makeSQL() + ") b on a.column1 = b.column "
                ...
                Model_VehicleSalesInvoice_Master loOldEntity = new Model_VehicleSalesInvoice_Master(poGRider);
                //replace with the primary key column info
